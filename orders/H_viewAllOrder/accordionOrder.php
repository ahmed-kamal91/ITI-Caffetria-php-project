        ...
        <div class="accordion-button collapsed" type="button"
            ...
            <div class="accordion-header-content">
                ...
                <div class="order-title">
                    ...
                    ?>
                    <span class="badge <?php echo $statusClass; ?> ms-2"><?php echo $statusText; ?></span>
                </div>

                <!-- Right: Status update & cancel -->
                <div class="status-actions">
                    <form method="POST" action="./H_viewAllOrder/updateStatus.php" class="d-flex align-items-center gap-2">
                        ...
                        <select name="status" class="form-select form-select-sm">
                            ...
                            <option value="out for delivery" <?php if ($orders['status'] === 'out for delivery') echo 'selected'; ?>>Out for Delivery</option>
                    ...
                    <?php if ($orders['status'] === 'Processing'): ?>
                        <form method="POST" action="./H_viewAllOrder/cancelOrder.php"
